...
class LoginPage(tk.Frame) :
	...
	def __init__(self, parent, App):
		...
		self.stockapp_label = tk.Label(self.main_frame, text="Stock Gudang", font=("Comic Sans MS", 28), bg="Black", fg="Brown")
		self.stockapp_label.pack()

		self.version_label = tk.Label(self.main_frame, text="Admin Version", font=("Comic Sans MS", 20), bg="Black", fg="Brown")
